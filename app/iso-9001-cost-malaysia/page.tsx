...
export default function ISO9001CostMalaysia() {
  return (
    <>
      <Header />
      <main className="pt-20">
        <Breadcrumb
          items={[
            { name: 'Home', href: '/' },
            { name: 'ISO 9001 Cost Malaysia', href: '/iso-9001-cost-malaysia' },
          ]}
        />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-600 mb-4">
                The total investment for ISO 9001 certification in Malaysia comprises several components.
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-6">
                <li><strong>Staff Time:</strong> Time for QMS coordinator, management, and employees participating in implementation</li>
                <li><strong>Training:</strong> Additional specialized training if required</li>
                <li><strong>Equipment:</strong> Calibration equipment, measuring tools if needed</li>
                <li><strong>Process Changes:</strong> Costs for implementing quality controls</li>
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-6">
                ...
                <li><strong>Document Updates:</strong> Keeping procedures current</li>
              </ul>
              ...
              <p className="text-gray-600 mb-4">
                Several factors influence your total ISO 9001 certification investment:
              </p>
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Manufacturing and complex services require more detailed controls</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
