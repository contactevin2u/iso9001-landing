const testimonials = [
  {
    ...
    content: 'The team made our ISO certification journey smooth and straightforward. Their expertise helped us achieve certification in just 4 weeks. Our operational efficiency improved significantly within the first year.',
    rating: 5,
  },
  {
    name: 'James Tan',
    ...
    <section id="testimonials" className="py-20 px-4 sm:px-6">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg text-gray-600 text-center max-w-2xl mx-auto mb-4">
          Trusted by over 156 Malaysian businesses for ISO certification
        </p>
