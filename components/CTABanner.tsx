...
export default function CTABanner({
  title = "Ready to Get ISO 9001 Certified?",
  subtitle = "Talk to our experts today and take the first step towards certification."
}: CTABannerProps) {
  return (
    <section className="py-12 px-4 sm:px-6 bg-gray-900">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="https://wa.me/60123456789?text=Hi%2C%20I%20am%20interested%20in%20ISO%209001%20certification."
            target="_blank"
