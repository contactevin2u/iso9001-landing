        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mt-12">
          ...
          <div className="bg-gray-50 rounded-md p-8 border border-gray-200">
            ...
            <p className="text-sm text-gray-600 border-t border-gray-200 pt-4 mb-6">
              Featured on BERNAMA TV (Ruang Bicara, July 2026) and in the Superbrands Malaysia CEO interviews.{' '}
              <a href="/media" className="font-medium text-primary-700 underline underline-offset-4 hover:text-primary-800">
