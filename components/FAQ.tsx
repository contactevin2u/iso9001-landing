...
const faqs: { question: string; summary: string; bullets: string[]; schemaAnswer: string }[] = [
  ...
  },
  {
    ...
    summary: 'Timelines depend on your size, complexity and how quickly documents come back. Typical breakdown:',
    bullets: [
      'SMEs (under 30 employees): fastest, with a target date agreed at kick-off',
      'Medium businesses (30-100 employees): longer, driven by scope and number of sites',
      'Certification body availability also affects the audit date',
    ...
    schemaAnswer: 'ISO 9001 certification timelines in Malaysia depend on organisation size, scope and how quickly documentation is reviewed, plus the certification body’s audit availability. We agree a target date at kick-off and handle documentation, process setup and audit preparation.',
  },
  {
    ...
    bullets: [
      'Many government tenders, GLC contracts and MNC supply chains require ISO 9001 from their suppliers',
      'Gives customers independent, accredited evidence of how you manage quality',
      'Improves operations — documented processes reduce errors, rework and waste',
    ...
    schemaAnswer: 'ISO 9001 is the world\'s most recognized Quality Management System (QMS) standard. Malaysian businesses need it because many government tenders and GLC contracts require it, it gives customers independent evidence of quality, improves operations, and is required for CIDB G7 and Petronas vendor registration.',
  },
  {
  ...
  },
  {
    ...
    schemaAnswer: 'Yes, ISO 9001 certification helps win Malaysian government tenders. It is required for CIDB G7 registration, Petronas vendor registration, and preferred in JKR and MOF procurement.',
  },
  {
    ...
    bullets: [
      ...
      'Thorough preparation beforehand is what keeps findings to a minimum',
    ],
