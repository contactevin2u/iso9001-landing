    ...
    <section id="what-is-iso" className="py-20 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-lg text-gray-600 leading-relaxed">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 sm:p-5 bg-gray-50 rounded-lg">
                <p className="font-medium text-gray-900">Clause 10: Improvement</p>
                <p className="text-sm text-gray-600">Nonconformity, corrective actions, and continual improvement</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-10 p-6 bg-primary-50 rounded-xl border border-primary-100">
          <p className="text-primary-800 text-center font-medium mb-4">
            Over 1 million organizations worldwide are ISO 9001 certified, including thousands in Malaysia
          </p>
          <div className="text-center">
            <a
              href="https://wa.me/601124102070?text=Hi%2C%20I%20want%20to%20understand%20how%20ISO%209001%20applies%20to%20my%20business."
              target="_blank"
            ...
            >
              ...
              Ask Our Consultants About ISO 9001
            </a>
          </div>
        </div>
      </div>
