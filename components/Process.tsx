const steps = [
  {
    ...
    details: 'During this free consultation, our ISO consultants will review your existing quality practices, understand your business operations, and explain the certification journey. We\'ll then send you a written proposal covering scope and investment. Paid work starts only after you accept it.',
  },
  {
    step: '2',
    title: 'Gap analysis',
    description: 'We identify what you already have in place and what needs to be developed.',
    details: 'Our comprehensive gap analysis compares your current practices against ISO 9001:2015 requirements. We\'ll document existing quality controls, identify compliance gaps, assess your processes and controls, and prioritize actions needed for certification. We then agree the project timeline with you, based on your readiness and the certification body\'s audit availability.',
  },
  {
    step: '3',
    title: 'Documentation',
  ...
  },
  {
    ...
    details: 'Our consultants perform a thorough internal audit to verify QMS effectiveness and identify any non-conformities. We train your internal audit team, facilitate management review meetings, and address any findings before the external certification audit.',
  },
  {
    step: '6',
    ...
    <section id="process" className="py-20 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto [&>*]:max-w-3xl">
        <h2 className="text-3xl sm:text-4xl mb-4">
          How we prepare you for certification
        </h2>
        <p className="text-lg text-gray-600 max-w-2xl mb-12">
          A clear, step-by-step approach to prepare you for certification. The timeline depends on
          your readiness and the certification body&apos;s audit date, and is agreed after the gap analysis.
        </p>
        ...
        <div className="mt-12 space-y-4">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-3.5 sm:px-8 sm:py-4 bg-primary-600 text-white font-semibold rounded-md hover:bg-primary-700 transition-colors text-base sm:text-lg"
          >
