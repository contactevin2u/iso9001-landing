    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="flex flex-col" aria-label="AA Alive, ISO certification consultants in Malaysia, home">
            <span className="font-serif text-2xl font-semibold text-ink leading-none tracking-tight">AA Alive</span>
            <span className="hidden sm:block text-xs text-gray-500 mt-1">ISO certification consultants, Malaysia</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-6" aria-label="Main navigation">
            ...
            <WhatsAppLink className="hidden lg:inline-flex items-center px-4 py-2.5 bg-primary-600 text-white text-sm font-semibold rounded-md hover:bg-primary-700 transition-colors">
              Free consultation
            </WhatsAppLink>
          </nav>
          ...
          <div className="flex items-center gap-2 md:hidden">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2.5 bg-primary-600 text-white text-xs font-semibold rounded-md hover:bg-primary-700 transition-colors"
            >
          ...
          <div id="mobile-menu" className="md:hidden py-4 border-t border-gray-100">
            <nav className="flex flex-col gap-4" aria-label="Mobile navigation">
              ...
              <div className="border-t border-gray-100 pt-4 mt-2">
                <div className="text-sm font-medium text-gray-900 mb-3">Guides</div>
